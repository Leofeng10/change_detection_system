...
def main():
    ...
    model_netG.load_state_dict(torch.load('C:/Users\Feng Zhunyi\Desktop/focal-frequency-loss-master\VanillaAE\experiments\celeba\checkpoints/netG_epoch_99999.pth', map_location=device))
